...
1. [Prototype Operation](#1-prototype-operation)
2. [Prototype Maintenance](#2-prototype-maintenance)
   1. [What if the machine jams](#21-what-if-the-machine-jams)
   2. [Replacing the chain](#22-replacing-the-chain)
